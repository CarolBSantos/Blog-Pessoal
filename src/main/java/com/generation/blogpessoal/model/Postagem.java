...
public class Postagem {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY) // AUTO_INCREMMENT
	private Long id;
	
	@NotBlank(message = "O atributo título é obrigatório e não pode utilizar espaços em branco!")
	@Size(min = 5, max = 100, message = "O atributo título deve conter no mínimo 05 e no máximo 100")
	private String titulo;
	
	@NotNull(message = "O atributo texto é obrigatório!")
	@Size(min = 10, max = 1000, message = "O atributo texto deve conter no mínimo 10 e no máximo 1000")
