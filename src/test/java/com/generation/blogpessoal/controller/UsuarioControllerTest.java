...
public class UsuarioControllerTest {
    ...
    public void deveBuscarUsuarioPorId() {
        ...
        // para garantir a independência do teste, é sempre bom cadastrar usuário antes
        // de implementar.
        Optional<Usuario> usuario = usuarioService
                .cadastrarUsuario(new Usuario(0L, "Maria de Lourdes", "maria13@email.com.br", "marimaria22", ""));
    ...
    public void deveLogarUmUsuario() {
        ...
        usuarioService.cadastrarUsuario(
                new Usuario(0L, "Henrique Moreira", "henriquem@email.com.br", "henri54321", ""));

        HttpEntity<UsuarioLogin> requisicao = new HttpEntity<UsuarioLogin>(
                new UsuarioLogin(0L, "", "henriquem@email.com.br", "henri54321", "", ""));
